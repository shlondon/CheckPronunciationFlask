...
#
#       Copyright (C) 2019-2021  Brigitte Bigi
#
...
if tier is None:
    ...
    sys.exit(1)
logging.info('Transcription tier was found: {:s}'.format(tier.get_name()))
...
for ann in tier:
    ...
    if ann.is_labelled() is False:
        ...
        continue
    if ann.label_is_string() is False:
        logging.error("Annotation {} is not string... ".format(ann))
        sys.exit(1)
