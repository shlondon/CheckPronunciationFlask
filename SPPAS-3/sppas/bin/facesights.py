...
# -*- coding: UTF-8 -*-
"""
:filename: sppas.bin.facesights.py
:author:   Brigitte Bigi
:contact:  develop@sppas.org
:summary:  Run the automatic face landmark detection annotation.
...
if __name__ == "__main__":
    ...
    parameters = sppasParam(["facesights.json"])
    ann_step_idx = parameters.activate_annotation("facesights")
    if ann_step_idx == -1:
