...
# -*- coding: UTF-8 -*-
"""
:filename: sppas.bin.faceidentity.py
:author:   Brigitte Bigi
:contact:  develop@sppas.org
:summary:  Run the automatic detections of faces in a video annotation.
...
if __name__ == "__main__":
    ...
    ann_step_idx = parameters.activate_annotation("faceident")
    if ann_step_idx == -1:
    ...
    group_io.add_argument(
        "-c",
        metavar="file",
        help='Input CSV file with face coordinates and sights.')
    ...
    arguments = vars(args)
    for a in arguments:
        if a not in ('i', 'o', 'e', 'c', 'I', 'quiet', 'log'):
    ...
    if args.i:
        ...
        parameters.set_output_extension(args.e, "VIDEO")
