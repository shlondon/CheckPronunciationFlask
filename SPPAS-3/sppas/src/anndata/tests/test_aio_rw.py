...
class TestAIO(unittest.TestCase):
    ...
    def test_IO_Properties(self):
        self.assertTrue("xra" in sppasTrsRW.annot_extensions())
    ...
    def test_IO_ANTX(self):
        ...
        # Read ANTX file
        parser = sppasTrsRW(os.path.join(DATA, "grenelle.antx"))
        trs1 = parser.read(heuristic=True)
        ...
        parser = sppasTrsRW(os.path.join(DATA, "sample-TGA.antx"))
        trs1 = parser.read(heuristic=True)
    ...
    def test_IO_EAF(self):
        ...
        # Read file
        parser = sppasTrsRW(os.path.join(DATA, "sample.eaf"))
        trs1 = parser.read(heuristic=True)
    ...
    def test_IO_TextGrid(self):
        ...
        # Read file
        parser = sppasTrsRW(os.path.join(DATA, "sample.TextGrid"))
        trs1 = parser.read(heuristic=True)
    ...
    def test_IO_PitchTier(self):
        ...
        # Read file
        parser = sppasTrsRW(os.path.join(DATA, "sample.PitchTier"))
        trs1 = parser.read(heuristic=True)
    ...
    def test_IO_MRK(self):
        ...
        # Read file
        parser = sppasTrsRW(os.path.join(DATA, "sample.mrk"))
        trs1 = parser.read(heuristic=True)
    ...
    def test_IO_HZ(self):
        ...
        # Read file
        parser = sppasTrsRW(os.path.join(DATA, "sample.hz"))
        trs1 = parser.read(heuristic=True)
    ...
    def test_IO_CTM(self):
        ...
        # Read file
        parser = sppasTrsRW(os.path.join(DATA, "sample.ctm"))
        trs1 = parser.read(heuristic=True)
    ...
    def test_IO_STM(self):
        ...
        # Read file
        parser = sppasTrsRW(os.path.join(DATA, "sample.stm"))
        trs1 = parser.read(heuristic=True)
    ...
    def test_IO_SRT(self):
        ...
        # Read file
        parser = sppasTrsRW(os.path.join(DATA, "sample.srt"))
        trs1 = parser.read(heuristic=True)
    ...
    def test_IO_SUB(self):
        ...
        # Read file
        parser = sppasTrsRW(os.path.join(DATA, "sample.sub"))
        trs1 = parser.read(heuristic=True)
    ...
    def test_IO_TXT(self):
        ...
        parser = sppasTrsRW(os.path.join(DATA, "sample-irish-1.txt"))
        trs1 = parser.read(heuristic=True)
        ...
        parser = sppasTrsRW(os.path.join(DATA, "sample.txt"))
        trs1 = parser.read(heuristic=True)
    ...
    def test_IO_CSV(self):
        ...
        parser = sppasTrsRW(os.path.join(DATA, "sample-irish.csv"))
        trs1 = parser.read(heuristic=True)
