# -*- coding: UTF-8 -*-
"""
:filename: sppas.src.anndata.aio.tests.test_aio_table.py
:author:   Brigitte Bigi
:contact:  develop@sppas.org
:summary:  Test the class sppasTable() to write ARFF, XRFF, TRA files.
...
from ..aio.table import sppasTable, sppasARFF, sppasXRFF
...
class TestTableExport(unittest.TestCase):
    """Test the export of annotations in time-tables.
    ...
    def test_setters(self):
        ...
        with self.assertRaises(IOError):
            weka.set_max_class_tags(0)
        with self.assertRaises(IOError):
            sppasTable.check_max_class_tags(110)
        ...
        with self.assertRaises(ValueError):
            sppasTable.check_max_attributes_tags(210)
    ...
    def test_check_metadata(self):
        ...
        weka.set_meta("table_max_class_tags", "50")
        weka.set_meta("table_max_attributes_tags", "30")
        weka.set_meta("table_empty_annotation_tag", "~")
        weka.set_meta("table_uncertain_annotation_tag", "%")
        weka.check_metadata()
        ...
        weka.set_meta("table_max_class_tags", "0")
        with self.assertRaises(IOError):
            weka.check_metadata()
        weka.set_meta("table_max_attributes_tags", "0")
        with self.assertRaises(IOError):
            weka.check_metadata()
        weka.set_meta("table_empty_annotation_tag", "")
        with self.assertRaises(IOError):
    ...
    def test_validate(self):
        ...
        with self.assertRaises(IOError):   # No class
            weka.validate()
        tier1.set_meta("table_class", "")
        with self.assertRaises(IOError):   # No attribute
            weka.validate()
        tier2.set_meta("table_attribute", "")
        ...
        weka.set_meta("table_instance_step", "0.04")
    ...
    def test_tier_is_attribute(self):
        ...
        t = sppasTranscription()
        tier1 = t.create_tier(name="tier1")
        is_att, is_num = sppasTable._tier_is_attribute(tier1)
        self.assertFalse(is_att)
        self.assertFalse(is_num)
        tier1.set_meta("table_attribute", "")
        is_att, is_num = sppasTable._tier_is_attribute(tier1)
        self.assertTrue(is_att)
        self.assertFalse(is_num)
        tier1.set_meta("table_attribute", "numeric")
        is_att, is_num = sppasTable._tier_is_attribute(tier1)
        self.assertTrue(is_att)
    ...
    def test_get_anchor_tier(self):
        ...
        tier1.set_meta("table_instance_anchor", "")
    ...
    def test_fix_all_possible_instance_steps(self):
        ...
        all_points = sppasTable._fix_all_possible_instance_steps(0., 10., time_step=0.01)  # phoneme frames
        self.assertEqual(len(all_points), 1000)
        all_points = sppasTable._fix_all_possible_instance_steps(0., 10., time_step=0.04)  # video frames
        self.assertEqual(len(all_points), 250)

        all_points = sppasTable._fix_all_possible_instance_steps(0., 10., anchor_tier=tier)
    ...
    def test_fix_instance_steps(self):
        ...
        weka.set_meta('table_instance_step', '0.1')
        all_points = sppasTable._fix_all_possible_instance_steps(1., 6., time_step=0.1)
        ...
        weka.pop_meta('table_instance_step')
        instances = weka._fix_instance_steps()
    ...
    def test_scores_to_probas(self):
        ...
        self.assertFalse(sppasTable._scores_to_probas([]))
        ...
        tag = sppasTag("")
        tags[tag] = None
        sppasTable._scores_to_probas(tags)
    ...
    def test_fix_data_instance(self):
        ...
        weka.set_meta("table_instance_step", "0.1")
        tier1.set_meta("table_class", "")
        tier2.set_meta("table_attribute", "string")
        tier3.set_meta("table_attribute", "numeric")
...
class TestWEKAFormats(unittest.TestCase):
    """Test an ARFF or XRFF file, the native formats of WEKA.
    ...
    def test_write_meta(self):
        ...
        arff.set_meta("table_instance_step", "0.04")
        lines = arff._serialize_metadata()
        self.assertEqual(len(lines.split("\n")), nb_lines+1)  # 1 more meta data
        self.assertTrue("table_instance_step" in lines)
    ...
    def test_write_attributes(self):
        ...
        arff = sppasARFF()
        arff.set(self.trs)
        self.tier1.set_meta("table_class", "")
        self.tier2.set_meta("table_attribute", "string")
    ...
    def test_write_data(self):
        ...
        weka.set_meta("table_instance_step", "0.1")
        tier1.set_meta("table_class", "")
        tier2.set_meta("table_attribute", "numeric")
