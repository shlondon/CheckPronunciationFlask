...
import sppas.src.ui.phoenix.page_analyze.filters.nlabfilter as nlabfilter
import sppas.src.ui.phoenix.page_analyze.filters.durfilter as durfilter
import sppas.src.ui.phoenix.page_analyze.filters.locfilter as locfilter
import sppas.src.ui.phoenix.page_analyze.filters.tagfilter as tagfilter
import sppas.src.ui.phoenix.page_analyze.filters.single as single
import sppas.src.ui.phoenix.page_analyze.filters.relation as relation
...
class TestPanel(wx.Choicebook):
    def __init__(self, parent):
        ...
        p = nlabfilter.TestPanel(self)
        self.AddPage(p, p.GetName())

        p = durfilter.TestPanel(self)
        self.AddPage(p, p.GetName())

        p = locfilter.TestPanel(self)
        self.AddPage(p, p.GetName())

        p = tagfilter.TestPanel(self)
        self.AddPage(p, p.GetName())

        p = single.TestPanel(self)
        self.AddPage(p, p.GetName())

        p = relation.TestPanel(self)
        self.AddPage(p, p.GetName())
