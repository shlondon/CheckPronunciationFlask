...
import sppas.src.ui.phoenix.page_editor.datactrls.dragwindow as dragwindow
import sppas.src.ui.phoenix.page_editor.datactrls.pointctrl as pointctrl
import sppas.src.ui.phoenix.page_editor.datactrls.layerctrl as layerctrl
...
class TestPanel(wx.Choicebook):
    def __init__(self, parent):
        wx.Choicebook.__init__(self, parent, style=wx.BORDER_NONE | wx.TAB_TRAVERSAL | wx.WANTS_CHARS)

        p = dragwindow.TestPanel(self)
        self.AddPage(p, p.GetName())

        p = pointctrl.TestPanel(self)
        self.AddPage(p, p.GetName())

        p = layerctrl.TestPanel(self)
        self.AddPage(p, p.GetName())
